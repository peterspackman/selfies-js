/**
 * Constants used throughout the SELFIES library
 */
...
export const AROMATIC_SUBSET = new Set(
  Object.keys(AROMATIC_VALENCES).map(e => e.toLowerCase())
);
...
export const INDEX_CODE: Record<string, number> = Object.fromEntries(
  INDEX_ALPHABET.map((c, i) => [c, i])
);